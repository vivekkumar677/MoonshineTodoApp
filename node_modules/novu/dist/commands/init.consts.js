...
exports.showWelcomeScreen = exports.termAndPrivacyQuestions = exports.emailQuestion = exports.passwordQuestion = exports.proceedSignupQuestions = exports.fullNameQuestion = exports.privateDomainQuestions = exports.registerMethodQuestions = exports.environmentQuestions = exports.existingSessionQuestions = exports.introQuestions = void 0;
...
exports.introQuestions = [
    {
        ...
        validate(input, answers) {
            if (['test', 'testnovu', 'testapp', 'novutest'].includes(input === null || input === void 0 ? void 0 : input.trim().toLowerCase().replace(/[^\w\s]/gi, ''))) {
...
We recommend writing your project or company name ;) If you're just curious about Novu, type 'curious'
        `;
            ...
            else if (!(input === null || input === void 0 ? void 0 : input.trim().length)) {
...
exports.existingSessionQuestions = existingSessionQuestions;
exports.environmentQuestions = [
    {
        type: 'list',
        name: 'env',
...
exports.registerMethodQuestions = [
    {
        type: 'list',
        name: 'value',
...
const privateDomainQuestions = (email) => [
    {
        name: 'domain',
        type: 'list',
...
exports.privateDomainQuestions = privateDomainQuestions;
exports.fullNameQuestion = [
    {
        type: 'text',
        name: 'fullName',
...
exports.proceedSignupQuestions = [
    {
        type: 'list',
        name: 'proceedSignup',
...
exports.passwordQuestion = [
    {
        type: 'password',
        name: 'password',
        message: 'Password',
        validate: (input) => {
            const match = input.match(shared_1.passwordConstraints.pattern);
            return match
                ? true
...
exports.termAndPrivacyQuestions = [
    {
        type: 'list',
        name: 'accept',
...
//# sourceMappingURL=init.consts.js.map